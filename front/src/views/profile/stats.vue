    ...
    <el-container direction="vertical">
      <el-header height="" class="informations-title">
        ...
        <el-row class="">
          ...
          to="/profile"
        >
          <el-col :span="4" :offset="3" style="margin: 1.5em 0;"><svg-icon style="width: 1.4em; height: 1em;"  name="right_arrow" class="rotate"/></el-col>
          </router-link>
          <el-col :span="17" ><h2>MES STATISTIQUES</h2></el-col>
        </el-row>
      </el-header>
