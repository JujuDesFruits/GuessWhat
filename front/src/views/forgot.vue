  ...
  private handleForgotPassword() {
    this.$refs.loginForm.validate(async(valid: boolean) => {
      if (valid) {
        this.loading = true;
        try {
          await UserAPI.forgotPassword({ email: this.loginForm.identifier });
          this.$notify.success("Un e-mail contenant un lien pour réinitialiser votre mot de passe vient de vous être envoyé");
        } catch (err) {
